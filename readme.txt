...
Please visit [http://magentacuda.com/a-shortcode-tester/](http://magentacuda.com/a-shortcode-tester/) for a very quick introduction.
**This plugin requires at least PHP 5.4.**

== Installation ==
1. Download the plugin from the WordPress repository.
2. Open the 'Plugins' menu item and activate the plugin.
3. Read the tutorial at [http://magentacuda.com/a-shortcode-tester/](http://magentacuda.com/a-shortcode-tester/).
